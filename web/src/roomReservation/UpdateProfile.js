...
import sampleUserData from './SampleUserData'; // Adjust the path accordingly
  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      try {
        ...
        // Example: Log the updated user data to the console
    ...
    <StyledContainer>
     <div style={{ display: 'flex', justifyContent: 'space-between', backgroundColor: '#838d97', alignItems: 'center', borderRadius: '10px' }}>
      ...
      <StyledForm onSubmit={handleSubmit}>
        ...
        <StyledH1 message="Update Profile" className="display-4" />
